...
def main():
    ...
    parser.add_argument('--outputs_dir', type=str,  default='/root/run/rcan/saved_models/DIV2K4')
    parser.add_argument('--preds_dir', type=str,  default='/root/run/rcan/preds_imgs/DIV2K4')
    parser.add_argument('--scale', type=int, default=4)
    parser.add_argument('--lr', type=float, default=1e-4)
    # parser.add_argument('--momentum', type=float, default=0.9)
    parser.add_argument('--patch_size', type=int, default=48)
    parser.add_argument('--batch_size', type=int, default=78)
    ...
    train_dataset = ImageDataset(hr_train_folder, lr_train_folder, patch_size=args.patch_size, scale = args.scale, transform=transform)
    train_dataloader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)

    hr_eval_folder = args.hr_eval_folder
    lr_eval_folder = args.lr_eval_folder
    eval_dataset = ImageDataset(hr_eval_folder, lr_eval_folder, patch_size=0, scale = args.scale, transform=transform)
